...
class monopile_15MW:
    ...
    def _calculations(self, found_age):
        ...
        print("installation duration turbine (days) = " +str(complete_installation_sequence_time*weather_delay_turbine/24)) if self.verbose else None
        ...
        print("installation duration monopile (days) = " +str(complete_installation_sequence_time_monopile*weather_delay_monopile/(amount_of_monopiles_per_sequence*24))) if self.verbose else None
        ...
        print("installation duration scour (days) = " +str(complete_installation_sequence_time_scour*weather_delay_scour/(24*amount_of_scour_per_sequence))) if self.verbose else None
        ...
        print("installation duration inter-array (days) = " +str(complete_installation_sequence_time_cable*weather_delay_inter_array/(24*100))) if self.verbose else None
        ...
        additional_equip_support_vessel = 150_000
        ...
        emissions_turbine_installation *= self.turbine_iterations
        emissions_turbine_decom *= self.turbine_iterations
        ...
        self.install_decom['foundation_install_cost'] = cost_of_monopile_installation
        self.install_decom['foundation_install_emissions'] = emissions_monopile_installation
        self.install_decom['foundation_decom_cost'] = monopile_decommissioning_cost
        self.install_decom['foundation_decom_emissions'] = emissions_monopile_decom
        ...
        #----------------------------------------------------------------------------------#
        #----------------------------------------------------------------------------------#
        #----------------------- supply chain metrics per turbine -------------------------#

        # self.final_metrics['Needed steel per turbine (tonnes)'] = (tower_mass +
        #                                                   monopile_mass +
        #                                                   transition_piece_mass + 
        #                                                   ((topside_structure/14500)+(monopile_substation_cost/2250))/(turbine_normalisation)
        #                                                   )
        
        # self.final_metrics['fiber glass (tonnes)'] = blade_weight*3

        # self.final_metrics['scour protection (tonnes)'] = scour_mass
        # self.final_metrics['inter-array cable length (km)'] = inter_cable_distance
        # self.final_metrics['export cable length (km)'] = self.distance_to_onshore_sub/turbine_normalisation

        # copper_per_turbine = 7.5 #tonnes
        # copper_per_inter_array = inter_cable_distance*(0.006*1000) #tonnes
        # copper_per_export_cable = self.distance_to_onshore_sub*(0.010*1000) #tonnes
        # copper_per_substation = 75 #tonnes, estimation

        # self.final_metrics['Copper need (tonnes)'] =(copper_per_turbine +
        #                                              copper_per_inter_array +
        #                                              (copper_per_export_cable/turbine_normalisation) +
        #                                              (copper_per_substation/turbine_normalisation))
        
        # ''' harbor size needed for a specific year'''
        # ''' can we assume that at one point, every wind farm component will be at a harbor at once?'''
