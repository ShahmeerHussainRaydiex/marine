...
class hybrid_caisson:
    ...
    def _calculations(self):
        ...
        caisson_cost_per_cube = 333.33 #€/m^3
        caisson_emissions_per_cube = 230 #kgCO2eq/m^3

        total_island_formation_cost = caisson_cost_per_cube*volume_island
        ...
        total_island_formation_emissions = caisson_emissions_per_cube*volume_island
        print('island formation emissions = ' +str(f'{total_island_formation_emissions:,}')) if self.verbose else None     
        
        #-------------------------------------------------------------------#
        #------------------------ OPEX -------------------------------------#

        yearly_island_OPEX = 1_000_000 #€/year
        yearly_island_OM_emissions = 1_300_000 #kgCO2eq/year
