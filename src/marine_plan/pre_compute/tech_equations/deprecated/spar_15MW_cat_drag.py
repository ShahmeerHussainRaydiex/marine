...
class spar_15MW_cat_drag:
    ...
    def _calculations(self):
        ...
        fuel_consumption_installation_anchor = (total_anchor_installation_time - (transit_to_anchor - transit_to_next_anchor - transit_to_harbor)/100)*ahv_fuel_installation
