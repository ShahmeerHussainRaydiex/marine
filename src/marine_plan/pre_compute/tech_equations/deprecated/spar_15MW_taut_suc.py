...
class spar_15MW_taut_suc:
    ...
    def _calculations(self):
        ...
        suction_pile_cost = drag_embedment_cost*7.4
       
        total_mooring_anchoring_catenary_per_turbine = (suction_pile_cost + line_cost)*amount_of_anchors #€
        
        #emission variables
        mooring_emissions = 1665
        suction_pile_emissions = 1799
        emissions_mooring_anchoring_catenary_per_turbine = (mooring_emissions*line_mass + suction_pile_emissions*suction_pile_mass)*amount_of_anchors
        ...
        suction_pile_install_multiplication_factor = 1.2

        #economic variable	
        anchor_installation_cost = (((total_anchor_installation_time/24)*(ahv_day_rate + additional_anchor_equipment_cost))*weather_factor)*suction_pile_install_multiplication_factor
    
        #emission variable
        fuel_consumption_transit_anchor = (transit_to_anchor + transit_to_harbor + transit_to_next_anchor)*ahv_fuel_transit/100
        fuel_consumption_installation_anchor = (total_anchor_installation_time - (transit_to_anchor - transit_to_next_anchor - transit_to_harbor)/100)*ahv_fuel_installation*suction_pile_install_multiplication_factor
