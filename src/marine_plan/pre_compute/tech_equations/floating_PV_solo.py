...
class floating_PV_solo:
    def __init__(self, geo_data, verbose=False):
        ...
        print("number of platforms = " +str(self.amount_of_platforms_per_square_km)) if self.verbose else None
        #lifetime
    ...
    def _calculations(self):
        ...
        solar_panel_emissions = 275 #kgCO2eq/panel
        ...
        baseline_emissions_for_one_platform = 6_000
        ...
        total_platform_emissions = ((self.mean_windspeed_at_10m - 5.7)*1396 + baseline_emissions_for_one_platform)
        ...
        total_anchoring_emissions = 350*anchors_per_platform #kgCO2eq
        ...
        print('total A_M emissions per platform = ' +str(A_M_emissions_wind)) if self.verbose else None
        #------------------------ Balance of system --------------#
        ...
        transformer_solar = 11_879*voltage
        transformer_emissions_solar = 2500*self.capacity_per_square_km

        #economic variables
        cable_cost_per_km	=400_000
        cable_cost =	cable_cost_per_km*((self.distance_to_onshore_sub)*excess_cable_factor) + transformer_solar
        cable_emission_per_km	=93537
        cable_emissions = cable_emission_per_km*((self.distance_to_onshore_sub)*excess_cable_factor) + transformer_emissions_solar
        ...
        yearly_OM_emissions = 220 #kgCO2eq per platform
        ...
        installation_emissions = 150 #kgCO2eq per platform
        ...
        decommissioning_emissions = 100 #kgCO2eq per platform
        ...
        print('platforms per square km = ' +str(self.amount_of_platforms_per_square_km)) if self.verbose else None
        print('solar panel emissions = ' +str(total_solar_panel_emissions)) if self.verbose else None
        print('solar platform emissions = ' +str(total_platform_emissions)) if self.verbose else None
        print('solar AM emissions = ' +str(A_M_emissions_wind)) if self.verbose else None
        print('solar BoS emissions = ' +str(total_BoS_emissions)) if self.verbose else None
        print('solar OM emissions = ' +str(total_OM_emissions_over_lifetime)) if self.verbose else None
        print('solar installation emissions = ' +str(installation_emissions)) if self.verbose else None
        print('solar decom emissions = ' +str(decommissioning_emissions)) if self.verbose else None
        print('solar cable emissions = ' +str(cable_emissions)) if self.verbose else None
        #------------------------------------------------------------------------------------------------------------#
        #--------------------------------- engineering costs -------------------------------------------------#
        ...
        NPV_emissions = NPV_calculator_emissions(total_emissions - (yearly_OM_emissions*self.lifetime),
                                                yearly_OM_emissions*self.lifetime,
