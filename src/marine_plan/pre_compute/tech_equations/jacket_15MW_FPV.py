...
class jacket_15MW_FPV:
    ...
    def _calculations(self):
        ...
        #economic variables
        cable_cost_per_km	=400000
        cable_cost_solar = cable_cost_per_km*((distance_to_sub_solar)*excess_cable_factor)
        cable_emission_per_km	=93537
        ...
        yearly_OM_emissions = 1.12*self.OPEX_reduction_solar #kgCO2eq per platform
        ...
        engineering_cost_overall = (jacket_design/(1000/15) + 
