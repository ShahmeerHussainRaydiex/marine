...
class mussel_longline:
    ...
    def _calculations(self):
        ...
        print("total dropper length per plot" + str(total_dropper_length_per_plot)) if self.verbose else None
        print('yearly_food_production_per_plot' + str(yearly_food_production)) if self.verbose else None
