...
class spar_15MW_taut_driv:
    ...
    def _calculations(self):
        ...
        emissions_spar_installation	= (fuel_consumption_transit + fuel_consumption_installation)*3*self.emission_factor_MDO #times 3 since 3 vessels needed for tugigng and positioning of turbine + substructure
