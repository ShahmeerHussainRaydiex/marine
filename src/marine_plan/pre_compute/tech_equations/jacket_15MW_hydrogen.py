...
class jacket_15MW_hydrogen:
    ...
    def _calculations(self):
        ...
        grating_rate = 180 #€/tonnes
        coating_rate = 120 #€/tonnes
        ...
        print(f'total OM emissions normalized = {total_lifetime_OM_emissions_hydrogen:,.2f}') if self.verbose else None
